window.onload = function() {
    ...
    for(var i=0;i<imgs.length; i++) { // 生成小span
        ...
        slider_ctrl.insertBefore(span,slider_ctrl.children[1]);  // 再 父元素 倒数第二个盒子的前面插入
    }
    // 下面的第一个小span  是默认的蓝色
    ...
    var timer = null;  // 定时器开始  其实， 定时器就是  右侧按钮
